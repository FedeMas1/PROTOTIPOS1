    ...
    public partial class SC : Form
    {
        ...
        private void CargarProductos(string rubroSeleccionado)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(connectionString))
            {
                ...
                string query = "SELECT codigo_Producto, Descripcion, (cantidad_maxima - cantidad) AS cantidad_a_pedir, marca, id_Rubro FROM Inventario WHERE id_Rubro = @Rubro AND cantidad < punto_pedido";
